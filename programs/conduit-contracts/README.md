...
| ---------- | ---------------------------------------------- | ------------------------------------------ |
| `escrow`   | `B42nssBXyLNK1y9YFZUwtzJcS8dzLYoTwony38YCTDiG`  | State-channel deposit / settle / refund    |
| `registry` | `6WMY6ymJkcT6AxcifmE8uzT5ZYQ4okZspFubxXg3TptS`  | On-chain catalog of API/agent/DePIN providers |
